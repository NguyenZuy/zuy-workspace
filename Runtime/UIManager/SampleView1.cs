...
{
    public class SampleView1 : UIView
    {
        #region Varaibles
        ...
        public SampleView1(VisualElement topElement, TransitionType transitionType = TransitionType.None) : base(topElement, transitionType)
        {
